...
import static com.mycompany.banksystem.Transaction.destinyAccount;
        ...
        switch (option) {
            case 1:
                ...
                if (newTransaction.findDestinyAccount(destinyAgency, destinyCheckingAccount)) {
                    ...
                    newTransaction.deposit(destinyAccount, amount);
                    destinyAccount = null;
            ...
            case 3:
                ...
                if (newTransaction.findDestinyAccount(destinyAgency, destinyCheckingAccount)) {
                    ...
                    newTransaction.transfer(destinyAccount, amount);
                    destinyAccount = null;
